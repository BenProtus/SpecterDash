...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        // let dashViewController = storyboard.instantiateViewController(withIdentifier: "DashViewController") as! DashViewController
        
        // TO DO: Update peripheral for DashView and push DashView to screen
        // dashViewController.peripheral = peripheral
